    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == exit) {
            ...
            if (checkLogin(nick1.getText())) {
                ...
                JOptionPane.showMessageDialog(this, "Đã tồn tại nick này trong room, bạn vui lòng nhập lại.", "Message Dialog", JOptionPane.WARNING_MESSAGE);
            }
