...
import LAN_Server.ClientConnect;
import LAN_Server.Server;
...
public class frmPlay extends javax.swing.JFrame {
     ...
     */
    public frmPlay() throws SQLException {
 ...
 private void go() {
    ...
    public void ShowQuestbyMaqt() throws SQLException {
        ...
        try {
            ...
            Logger.getLogger(frmPlay.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    public void checkketqua() {
        if (demquestion == 1) {
            JOptionPane.showMessageDialog(null, "Bạn không nhận được tiền thưởng từ chương trình", "thong bao", 1);
        } else {
            if (demquestion < 5) {
                JOptionPane.showMessageDialog(null, "Bạn nhận được:200.000đ tiền thưởng từ chương trình", "thong bao", 1);
            }
            if (demquestion >= 5 && demquestion < 10) {
                JOptionPane.showMessageDialog(null, "Bạn nhận được:2.000.000đ tiền thưởng từ chương trình", "thong bao", 1);
            }
            if (demquestion >= 10 && demquestion < 15) {
                JOptionPane.showMessageDialog(null, "Bạn nhận được:20.000.000đ tiền thưởng từ chương trình", "thong bao", 1);
            }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button/Khung tl.png"))); // NOI18N
        jLabel2.setText("B");
        jPanel3.add(jLabel2);
    ...
    private void btnAnswerBbtnAnswerAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAnswerBbtnAnswerAMouseClicked
        ...
        if (mh == JOptionPane.YES_OPTION) {
            ...
            if (chonb.equals(dapan)) {
                ...
                JOptionPane.showMessageDialog(null, "Sai rồi !!!!!!!!", "thong bao", 1);
            }
            try {
                checkdapan();
    ...
    private void btnDungcuocchoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDungcuocchoiActionPerformed
        ...
        if (nhacnho == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(null, "Bạn nhận được: " + lblthuong.getText() + ".000đ tiền thưởng của chương trình", "thong bao", 1);
            this.dispose();
        }
